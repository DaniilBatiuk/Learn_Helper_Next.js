...
export function TranslateItem({ translateItem, voiceIndex }: TranslateItemProps) {
    ...
    <div className="dictionary__item">
      <div className="dictionary__action">
        ...
        <div className="dictionary__form">
          <button className="dictionary__delete" onClick={() => window.speechSynthesis.speak(speech)}>
