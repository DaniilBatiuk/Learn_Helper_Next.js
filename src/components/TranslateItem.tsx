...
export function TranslateItem({ translateItem, voiceEN }: TranslateItemProps) {
    ...
    <div className="dictionary__item">
      <div className="dictionary__action">
        ...
        <div className="dictionary__form">
          <button className="dictionary__delete" onClick={() => speak({ text: translateItem.word, voice: voiceEN })}>
